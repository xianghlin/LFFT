...
class LFFT(nn.Module):
    ...
    def load_param(self, model_path):
        ...
        for k, v in param_dict.items():
            k = k.replace('base.', '').replace('module.', '')  
...
def vit_base_patch16_224_LFFT(img_size=(256, 256), stride_size=16, drop_rate=0.0, attn_drop_rate=0.0, drop_path_rate=0.1, camera=0, view=0,local_feature=False,sie_xishu=1.5, **kwargs):
    model = LFFT(
